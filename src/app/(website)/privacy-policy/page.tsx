...
const SECTIONS = [
  ...
  { id: "how-use",        label: "2. How We Use Your Information",         icon: FaUserCheck },
  { id: "publicly-visible", label: "3. Publicly Visible Information",      icon: FaEye },
  { id: "data-sharing",  label: "4. Data Sharing & Disclosure",            icon: FaGlobe },
  { id: "cookies",       label: "5. Cookies & Tracking",                   icon: FaCookieBite },
  { id: "your-rights",   label: "6. Your Rights (DPDP Act, 2023)",         icon: FaShieldAlt },
  { id: "retention",     label: "7. Data Retention & Security",            icon: FaLock },
  { id: "children",      label: "8. Children's Privacy",                   icon: FaChild },
  { id: "third-party",   label: "9. Third-Party Links & Services",         icon: FaLink },
  { id: "changes",       label: "10. Changes to This Policy",              icon: FaSyncAlt },
        ...
        <div className="container" style={{ maxWidth: 1200 }}>
          <div className="terms-layout">
            ...
            <aside className="terms-sidebar">
              ...
              <nav>
                {SECTIONS.map((s) => (
                  <a key={s.id} href={`#${s.id}`} className="terms-toc-btn">
                    {s.label}
                  </a>
                ))}
              </nav>
              ...
              <div className="terms-intro-card">
                ...
                <div className="pp-meta-row">
                  <div className="pp-meta-chip">
                    <FaEnvelope /> khurjadeals@gmail.com
                  </div>
                  <div className="pp-meta-chip">
                    <FaPhoneAlt /> +91 9258550570
                  </div>
                  <div className="pp-meta-chip">
                ...
                <div className="terms-contact-card" style={{ marginBottom: 20 }}>
                  ...
                  <div className="terms-contact-row">
                    ...
                    <div>
                      ...
                      <a href="mailto:khurjadeals@gmail.com" className="terms-link">khurjadeals@gmail.com</a>
                    </div>
                  </div>
                  <div className="terms-contact-row">
                    ...
                    <div>
                      ...
                      <a href="tel:+919258550570" className="terms-link">+91 9258550570</a>
                    </div>
                  </div>
                  <div className="terms-contact-row">

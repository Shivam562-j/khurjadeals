  ...
  const columns: TableColumn<Product>[] = [
    ...
    },
    {
      ...
      render: (item) => {
        ...
        return (
          <span
            className={`capitalize font-semibold text-xs px-2.5 py-0.5 rounded-full border ${
              cond === "new"
  ...
  return (
    <div className="p-4 sm:p-6 bg-[#0d0d0d] h-full w-full flex flex-col min-h-0">
      ...
      <div className="bg-[#171717] flex flex-col h-[600px] lg:h-full lg:flex-1 min-h-0 rounded-xl border border-[#262626] overflow-hidden shadow-2xl">
        {/* TopHeader with title: Product List, search onEnter, filters, orange 'New Product' button, and CSV Export */}
        <TopHeader
          title="Product List"
